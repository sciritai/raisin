...
infos = percentages.map(function(val, index) {
  new Info(amounts[index], val, maturities[index]);
})

document.querySelectorAll("div.row.styles_depositCardMain___3a-Kb > div.styles_progressBar___2blqr > div").map(function (div, index) {
